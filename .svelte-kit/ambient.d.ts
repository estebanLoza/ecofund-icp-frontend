...
declare module '$env/static/private' {
	...
	export const CANISTER_CANDID_PATH_ECOFUND_ICP_BACKEND: string;
	export const CANISTER_ID_INTERNET_IDENTITY: string;
	export const CANISTER_ID_ECOFUND_ICP_FRONTEND: string;
	export const CANISTER_ID_ECOFUND_ICP_BACKEND: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		DFX_VERSION: string;
		DFX_NETWORK: string;
		CANISTER_CANDID_PATH_ECOFUND_ICP_BACKEND: string;
		CANISTER_ID_INTERNET_IDENTITY: string;
		CANISTER_ID_ECOFUND_ICP_FRONTEND: string;
		CANISTER_ID_ECOFUND_ICP_BACKEND: string;
		CANISTER_ID: string;
