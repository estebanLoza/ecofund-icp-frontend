...
// ../../node_modules/carbon-icons-svelte/lib/Ai.svelte
var file = "home/estebanhl/Desktop/ecofund_ICP/node_modules/carbon-icons-svelte/lib/Ai.svelte";
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(path, "d", "M17 11L20 11 20 21 17 21 17 23 25 23 25 21 22 21 22 11 25 11 25 9 17 9 17 11zM13 9h-4c-1.103 0-2 .897-2 2v12h2v-5h4v5h2v-12c0-1.103-.897-2-2-2zm-4 7v-5h4v5h-4z");
...
var Ai = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
  ...
  get size() {
    throw new Error("<Ai>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  set size(value) {
    throw new Error("<Ai>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  get title() {
    throw new Error("<Ai>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
...
//# sourceMappingURL=carbon-icons-svelte_lib_Ai__svelte.js.map
