...
import {
  ...
  text,
  validate_slots
} from "./chunk-QWPLCQWJ.js";
import "./chunk-HRRA2RYJ.js";
import "./chunk-2B2CG5KL.js";

// ../../node_modules/carbon-icons-svelte/lib/UserAvatarFilledAlt.svelte
var file = "home/estebanhl/Desktop/ecofund_ICP/node_modules/carbon-icons-svelte/lib/UserAvatarFilledAlt.svelte";
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(path1, file, 23, 55, 626);
...
function instance($$self, $$props, $$invalidate) {
  ...
  validate_slots("UserAvatarFilledAlt", slots, []);
  let { size = 16 } = $$props;
...
var UserAvatarFilledAlt = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance, create_fragment, safe_not_equal, { size: 0, title: 1 });
    dispatch_dev("SvelteRegisterComponent", {
      component: this,
      tagName: "UserAvatarFilledAlt",
      options,
      id: create_fragment.name
    });
  }
  get size() {
    throw new Error("<UserAvatarFilledAlt>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  set size(value) {
    throw new Error("<UserAvatarFilledAlt>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  get title() {
    throw new Error("<UserAvatarFilledAlt>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
...
var UserAvatarFilledAlt_default = UserAvatarFilledAlt;
export {
  UserAvatarFilledAlt_default as default
};
//# sourceMappingURL=carbon-icons-svelte_lib_UserAvatarFilledAlt__svelte.js.map
